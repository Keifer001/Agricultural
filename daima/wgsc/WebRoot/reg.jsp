...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
	<td height="80" background="images/fg_top.jpg"></td>
  </tr>
</table>
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF" style="border:1px; border-style:solid; border-color:#888888">
  <tr>
    ...
    <TD height="50" align="right" valign="bottom">
		...
		<INPUT id="qKey" name="qKey" value="蔬菜关键字" onClick="this.value=''"> 
		<SELECT id="category" name="category">
			<option value="0">所有蔬菜</option>
		</SELECT>
	...
	<html:form action="/mem.do?method=reg" style="margin:0px;" onsubmit="return validateMemberForm(this);">
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#FFFFFF" align="left">
		  ...
		  <tr bgcolor="#F7F3F7">
			...
			<td height="26"><html:text property="phone" size="30" styleClass="textBox"/><font color="red" size="2">&nbsp;例：024-58868888或01075888888</font></td>
		  </tr>
		  <tr bgcolor="#F7F3F7">
		  ...
		  <tr bgcolor="#F7F3F7">
			...
			<td height="26"><html:text property="email" size="30" styleClass="textBox"/><font color="red" size="2">&nbsp;例：12345@qq.com</font></td>
		  </tr>
		  <tr>
...
<script language="javascript">
	...
	function QuickSearch(){
		...
		if (key !=null && key!="蔬菜关键字" && key.length>0)url = url+"&key="+key;
		window.location = url;
	}
</script>	
</body>
